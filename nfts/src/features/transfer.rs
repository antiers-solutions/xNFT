...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	pub(crate) fn do_transfer_ownership(
		...
		frame_support::log::warn!("bhai do_transfer me aagya");
		let acceptable_collection = OwnershipAcceptance::<T, I>::get(&owner);
		frame_support::log::warn!("bhai acceptable_collection me aagya");
		ensure!(acceptable_collection.as_ref() == Some(&collection), Error::<T, I>::Unaccepted);
		frame_support::log::warn!("bhai acceptable_collection ka ensure bi par karliya");
		Collection::<T, I>::try_mutate(collection, |maybe_details| {
			...
			frame_support::log::warn!("bhai Collection ka storage bi par karliya");
